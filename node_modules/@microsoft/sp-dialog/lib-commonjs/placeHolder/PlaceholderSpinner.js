    ...
    PlaceholderSpinner.prototype.render = function () {
        ...
        if (!(0, KillSwitches_1.isUsingV9ForSPDialogKSActivated)()) {
            return (React.createElement("div", { className: 'Placeholder-overlay' },
                React.createElement("div", { className: 'Placeholder-spinnerContainer' }, this.state.showSpinner && React.createElement(react_components_1.Spinner, { size: 'small', label: this.props.label }))));
        }
