...
})(DialogState || (exports.DialogState = DialogState = {}));
/**
...
var BaseDialog = /** @class */ (function () {
    ...
    Object.defineProperty(BaseDialog.prototype, "secondaryDialogProvider", {
        ...
        get: function () {
            ...
            if (!this._secondaryDialogProvider && this._requestId) {
                this._secondaryDialogProvider = DialogManager_1.default.instance.createSecondaryDialogProvider(this._requestId);
            }
    ...
    BaseDialog.prototype._setState = function (newState) {
        ...
        sp_diagnostics_1._TraceLogger.logVerboseData({
            ...
            message: "Dialog state changed from '".concat(DialogState[this._state], "' to '").concat(DialogState[newState], "'.")
        });
    ...
    BaseDialog._logSource = sp_diagnostics_1._LogSource.create('BaseDialog');
    return BaseDialog;
}());
