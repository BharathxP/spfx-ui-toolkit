...
import type { EnsureExtends } from '@microsoft/sp-core-library';
import type { ExtractFromSet } from '@microsoft/sp-core-library';
...
import type { ICardElement } from 'adaptivecards';
...
import { _IComponentPosition } from '@microsoft/sp-component-base';
 ...
 *
 * @remarks See {@link SupportedBarChartDataTypes} for valid types.
 *
 * @public
 */
export declare type BarChartData<Type> = ExtractFromSet<SupportedBarChartDataTypes, Type>;

/* Excluded from this release type: _BarChartParameters */
...
export declare class BaseAdaptiveCardExtension<TProperties extends {} = {}, TState extends {} = Readonly<{}>> extends BaseComponent {
    ...
    private _assignAndRenderWebQuickView;
    /**
 ...
 * @public
 */
export declare abstract class BaseAdaptiveCardQuickView<TProperties extends {} = {}, TState extends {} = {}, TData = {}> extends BaseQuickView<TProperties, TState> implements IAdaptiveCardExtensionDataView<TData>, IAdaptiveCardExtensionActionView {
 ...
 */
export declare abstract class BaseAdaptiveCardView<TProperties extends {} = {}, TState extends {} = {}, TData = {}> extends BaseAdaptiveCardQuickView<TProperties, TState, TData> {
}
 ...
 * @public
 */
export declare abstract class BaseBasicCardView<TProperties extends {} = {}, TState extends {} = {}> extends BaseTemplateCardView<TProperties, TState, IBasicCardParameters> {
 ...
 * @sealed
 */
export declare abstract class BaseCardView<TProperties extends {} = {}, TState extends {} = {}> extends BaseView<TProperties, TState> implements IAdaptiveCardExtensionActionView {
    /* Excluded from this release type: _templateType */
 ...
 * @public
 */
export declare abstract class BaseComponentsCardView<TProperties extends {} = {}, TState extends {} = {}, TParameters extends ComponentsCardViewParameters = ITextCardViewParameters> extends BaseCardView<TProperties, TState> {
    /* Excluded from this release type: _getCardViewParameters */
    /**
    ...
    /* Excluded from this release type: _ensureCardBarParameters */
}
 ...
 * @public
 */
export declare abstract class BaseImageCardView<TProperties extends {} = {}, TState extends {} = {}> extends BaseTemplateCardView<TProperties, TState, IImageCardParameters> {
    /* Excluded from this release type: _templateType */
    /* Excluded from this release type: _getCardViewParameters */
    /**
...
/**
 * Base type to enforce correct type of arguments passed to {@link BaseAdaptiveCardExtension.onBeforeAction}.
 *
 * @public
 */
export declare type BaseOnBeforeActionArguments<T extends IBaseOnBeforeActionArguments> = IActionArguments | EnsureExtends<T, IBaseOnBeforeActionArguments>;
 ...
 * @public
 */
export declare abstract class BasePrimaryTextCardView<TProperties extends {} = {}, TState extends {} = {}> extends BaseTemplateCardView<TProperties, TState, IPrimaryTextCardParameters> {
    /* Excluded from this release type: _templateType */
    /* Excluded from this release type: _getCardViewParameters */
    /**
 ...
 * @public
 */
export declare abstract class BaseQuickView<TProperties extends {} = {}, TState extends {} = {}> extends BaseView<TProperties, TState> {
    /* Excluded from this release type: _viewType */
    /**
 ...
 * @sealed
 */
export declare abstract class BaseTemplateCardView<TProperties extends {} = {}, TState extends {} = {}, TData extends IBaseCardParameters = IBaseCardParameters> extends BaseCardView<TProperties, TState> implements IAdaptiveCardExtensionDataView<TData> {
    /**
 ...
 * @sealed
 */
export declare abstract class BaseView<TProperties extends {} = {}, TState extends {} = {}> {
 ...
 * @public
 */
export declare abstract class BaseWebQuickView<TProperties extends {} = {}, TState extends {} = {}> extends BaseQuickView<TProperties, TState> {
    /* Excluded from this release type: _viewType */
    /* Excluded from this release type: _domElement */
    /* Excluded from this release type: _setDomElement */
    /**
     * Update the state of the Adaptive Card Extension.
     *
     * @remarks - This method will not trigger a re-render and only update the ACE with the new state.
     *
     * @param newState - The new state to set.
     */
    setState(newState?: Partial<TState> | undefined): void;
    /**
     * This API is called to render the HTML quick view.
     * It will be invoked when opening this view.
     * @virtual
     */
    abstract render(): void;
    /**
     * Disposes the quick view.
     *
     * @remarks - This method is invoked when HTML Quick View's DOM element is removed from the Document.
     * It will trigger when quick view modal is closed, or navigating between quick views.
     *
     * @virtual
     */
    dispose(): void;
    /**
     * Reference to the DOM element that hosts this quick view.
...
/* Excluded from this release type: _BODY_PRIMARY_TEXT */
 ...
 * @public
 */
export declare type CardComponentName = 'text' | 'cardButton' | 'cardBar' | 'textInput' | 'searchBox' | 'searchFooter' | 'dataVisualization' | 'poweredBy' | 'promptsSet';
 ...
 * @public
 */
export declare type CardDataVisualizationKind = 'bar' | 'line' | 'pie';
...
/* Excluded from this release type: _CardViewParametersProcessor */

/* Excluded from this release type: _CardViewParametersProcessors */
 ...
 * @public
 */
export declare type ComponentsCardViewParameters = ITextCardViewParameters | ITextInputCardViewParameters | ISearchCardViewParameters | IDataVisualizationCardViewParameters;

/* Excluded from this release type: _CopilotCardView */
...
/* Excluded from this release type: _EmptyQuickView */
...
/**
 * The object passed to {@link @microsoft/sp-adaptive-card-extension-base#IAdaptiveCardExtensionActionView.onAction} when an Adaptive Card Action is executed.
 *
 * @remarks Only `Submit`, `ShowCard`, `Execute`, 'Viva.SelectMedia', and 'Viva.GetLocation'; actions are routed to the {@link @microsoft/sp-adaptive-card-extension-base#IAdaptiveCardExtensionActionView.onAction} handler.
 *
 * @public
 */
 ...
 * @public
 */
export declare interface IAxis<T> {
    /**
     * An array of reference points to be represented as ticks on the axis.
     *
     * @remarks The number of data points is limited to ensure optimal display quality. The limit depends on the size of the card and dataVisualizationKind:
     *
     * For a Line Chart:
     *  - Large: 2 to 6 data points for the x-axis
     *  - Medium: 2 to 3 data points for the x-axis
     *  - 2 to 4 data points for the y-axis
     * For a Bar Chart:
     * - Large: upto 5 data points for the x-axis
     * - Medium: upto 3 data points for the x-axis
     */
    labelValues?: T[];
    /* Excluded from this release type: _displayString */
    /**
     * A function that formats the labels for the data points on the axis.
     *
     * @remarks If no formatter is provided, a default formatter will be used.
     *
     * @param value - The data point to be formatted.
     * @returns The formatted string for the data point.
     */
 ...
 * @public
 */
export declare interface IBarChartCardViewConfiguration<T extends BarChartData<T>> extends IDataVisualizationCardViewConfiguration {
    /**
...
/* Excluded from this release type: _IBarChartMetadata */

/**
 * Series for a bar chart.
 *
 * @remarks It is expected that the data in all series have consistent and limited x values.
 * @remarks  The number of points rendered on the x-axis is predefined:
 * - Large Chart: Limited to five points (displayed when a card view contains no more than three components).
 * - Medium Chart: Limited to three points for a single series and two points for multiple series.
 *
 * @public
 */
export declare interface IBarChartSeries<T> extends IBaseSeries {
    /**
     * Data for the series.
     */
    data: IDataPoint<T>[];
...
/**
 * Base object passed to {@link @microsoft/sp-adaptive-card-extension-base#IAdaptiveCardExtensionActionView.onAction} when an Adaptive Card Action is executed.
 *
 * @remarks Only `Submit` and `ShowCard` actions are routed to the {@link @microsoft/sp-adaptive-card-extension-base#IAdaptiveCardExtensionActionView.onAction} handler.
 *
 * @public
 */
 ...
 * @public
 */
export declare interface IBaseCardDataVisualizationParameters extends ICardComponentParameters {
    /**
     ...
     *
     * @remarks The 'aria-label' attribute provides an accessible name for the component, which can be used by assistive technologies to identify the component.
     * @remarks For example, "Revenue by month".
     */
    ariaLabel?: string;
    /**
     * The 'aria-description' attribute for the data visualization component.
     *
     * @remarks The 'aria-description' attribute provides additional information about the component, which can be used by assistive technologies to provide more context to the user.
     * @remarks For example, "Line chart showing revenue by month from January to December".
     */
...
/* Excluded from this release type: _IBaseCartesianChartMetadata */

/* Excluded from this release type: _IBaseDataVisualizationMetadata */
...
/**
 * Base object passed to {@link BaseAdaptiveCardExtension.onBeforeAction}.
 *
 * @public
 *
 ...
 * @public
 */
export declare interface IBaseSeries {
    /**
     * Name of the series.
     *
     * @remarks Displayed in the legend.
     */
    name?: string;
}
 ...
 * @public
 */
export declare interface ICardBarChartConfiguration<T extends BarChartData<T>> extends CardComponentConfiguration<ICardBarChartParameters<T>> {
}
 ...
 * @public
 */
export declare interface ICardBarChartParameters<T extends BarChartData<T>> extends ICartesianChartParameters<T> {
    /**
     * Bar chart
     */
     ...
     */
    series: MaxThreeTuple<IBarChartSeries<T>>;
    /**
     * Flag to indicate if data labels need to be shown or not.
     *
     * @remarks Data labels will be shown only if all of these conditions are met:
     * - showDataLabels is true
     * - Only cardBar and dataVisualization component (bar chart) are present in the card
     * - Only a single series is present in the dataVisualization component
     * - The size of the card is large
     *
 ...
 * @public
 */
export declare interface ICardLineChartConfiguration<T extends LineChartData<T>> extends CardComponentConfiguration<ICardLineChartParameters<T>> {
}
 ...
 * @public
 */
export declare interface ICardLineChartParameters<T extends LineChartData<T>> extends ICartesianChartParameters<T> {
    /**
     * Line chart
     */
     ...
     * @remarks Can be a single series or multiple (upto 3) series.
     */
    series: MaxThreeTuple<ILineChartSeries<T>>;
    /* Excluded from this release type: _metadata */
}
 ...
 * @public
 */
export declare interface ICardPieChartConfiguration extends CardComponentConfiguration<ICardPieChartParameters> {
}
 ...
 * @public
 */
export declare interface ICardPieChartParameters extends IBaseCardDataVisualizationParameters {
    /**
     * Pie chart
     */
...
/* Excluded from this release type: _ICardViewParametersProcessorContext */
 ...
 * @public
 */
export declare interface ICartesianChartParameters<T> extends IBaseCardDataVisualizationParameters {
    /**
     * Parameters for the X axis of the chart.
     *
     * @remarks This includes positions on xAxis to be represented as ticks, and a formatter function for the data point labels.
     */
    xAxis?: IAxis<T>;
    /**
     * Parameters for the Y axis of the chart.
     *
     * @remarks This includes positions on yAxis to be represented as ticks, and a formatter function for the data point labels.
     */
    yAxis?: IAxis<number>;
}
...
/* Excluded from this release type: _ICopilotCardViewConfiguration */

/* Excluded from this release type: _ICopilotCardViewParameters */
 ...
 *
 * @remarks The DataVisualization Card view displays the following:
 *  - Card Title
 *  - Card Icon
 *  - One or zero primary text field
 *  - One or zero secondary text fied
 *  - One chart
 *  - Up to one button in `Large` Card size
 *
 * @public
 */
export declare interface IDataVisualizationCardViewConfiguration extends Omit<ICardViewConfiguration, 'image' | 'header' | 'footer'> {
    /**
     * Header area components.
     */
    header?: ICardTextConfiguration;
 ...
 * @public
 */
export declare interface IDataVisualizationCardViewParameters extends ICardViewParameters {
    /**
     * Card View type
     */
     ...
     * Header area components.
     */
    header: [ICardTextParameters] | undefined;
    /**
     * Body area components.
     */
    body: [IBaseCardDataVisualizationParameters] | [ICardTextParameters, IBaseCardDataVisualizationParameters];
    /**
     * Footer area components.
     */
    footer: [ICardButtonParameters] | undefined;
}

/* Excluded from this release type: _IExecuteAction */

/**
 * The object passed to {@link @microsoft/sp-adaptive-card-extension-base#IAdaptiveCardExtensionActionView.onAction} when a `Execute` Action is executed.
...
export declare interface IFocusParameters {
    ...
    /* Excluded from this release type: _lastFocusedElement */
}
...
/**
 * The object passed to {@link @microsoft/sp-adaptive-card-extension-base#IAdaptiveCardExtensionActionView.onAction} when a Get location Action is executed.
 ...
 * @public
 */
export declare interface ILineChartCardViewConfiguration<T extends LineChartData<T>> extends IDataVisualizationCardViewConfiguration {
    /**
     * Body area components.
     */
...
/* Excluded from this release type: _ILineChartMetadata */
 ...
 * @public
 */
export declare interface ILineChartSeries<T> extends IBaseSeries {
    /**
     * Data for the series.
     */
    data: IDataPoint<T>[];
 ...
 * @public
 */
export declare type IOnBeforeActionArguments = BaseOnBeforeActionArguments<IQuickViewActionArguments | IExternalLinkActionArguments | IShowLocationActionArguments>;
 ...
 * @public
 */
export declare interface IPieChartCardViewConfiguration extends IDataVisualizationCardViewConfiguration {
    /**
     * Body area components.
     */
    body: ICardPieChartConfiguration | [ICardPieChartConfiguration] | [ICardTextConfiguration, ICardPieChartConfiguration];
}

/* Excluded from this release type: _IPieChartMetadata */
 ...
 * @public
 */
export declare interface IPieChartSeries {
    /**
     * Data for the series.
     * @remarks Any number of data points can be provided. However, the number of categories shown will be as follows based on the layout of the card:
     * - Top 10 categories for large cards with just the data visualization component.
     * - Top 8 categories for medium cards or cards with 2 out of the three elements (header, description, footer).
     * - Top 6 categories for cards with either header or description or footer along with the data visualization component.
     *
 ...
 * @remarks The category is to ge given as x in IDataPoint and the value as y in IDataPoint
 * @public
 */
export declare interface IPieDataPoint extends IDataPoint<string> {
    /**
     ...
     * @remarks If not provided, it will be constructed from the category and value subject to the following constraints:
     *
     * A finite number of labels will be shown as part of the default experience:
     *  - 6 labels for large cards with just the data visualization component.
     *  - 4 labels for medium cards or cards with 2 out of the three elements (header, description, footer). Only percentage will be shown in the label in this case omiiting the category.
     *  - 2 labels for cards with either header or description or footer along with the data visualization component.
     * If provided, category (x) and value (y) will be shown in the format: 'cat:xy%', where 'cat' is the first three characters of the category and 'xy' is the proportion of the value to the total.
     * @remarks The above numbers indicate the maximum number of labels that will be shown for the respective card layouts. If the provided number of labels exceeds the limit, the excess labels will be hidden.
     */
    showLabel?: boolean;
    /* Excluded from this release type: _dataLabel */
}

/* Excluded from this release type: _IPoweredByConfiguration */

/* Excluded from this release type: _IPoweredByParameters */
...
/* Excluded from this release type: _IPromptsSetConfiguration */

/* Excluded from this release type: _IPromptsSetParameters */
...
/**
 * The object passed to {@link @microsoft/sp-adaptive-card-extension-base#IAdaptiveCardExtensionActionView.onAction} when a `SelectMedia` Action is executed.
...
/**
 * The object passed to {@link @microsoft/sp-adaptive-card-extension-base#IAdaptiveCardExtensionActionView.onAction} when a `ShowCard` Action is executed.
 *
 * @public
 */
 ...
 * @public
 */
export declare interface IShowLocationActionArguments extends IBaseOnBeforeActionArguments, IShowLocationCardAction {
}
...
/**
 * The object passed to {@link @microsoft/sp-adaptive-card-extension-base#IAdaptiveCardExtensionActionView.onAction} when a `Submit` Action is executed.
 *
 * @public
 */
...
/* Excluded from this release type: _isUpdateSelectActionIdKSActivated */
...
/* Excluded from this release type: _IViewStackItem */

/* Excluded from this release type: _IWebQuickViewRenderParameters */
 ...
 *
 * @remarks See {@link SupportedLineChartDataTypes} for valid types.
 *
 * @public
 */
export declare type LineChartData<Type> = ExtractFromSet<SupportedLineChartDataTypes, Type>;

/* Excluded from this release type: _LineChartParameters */
...
/* Excluded from this release type: _PRIMARY_TEXT */
 ...
 * @public
 */
export declare type SupportedBarChartDataTypes = [string, number, Date];
...
/* Excluded from this release type: _TITLE_TEXT */
