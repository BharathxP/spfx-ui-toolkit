...
var AdaptiveCardExtensionLoader = /** @class */ (function () {
    ...
    AdaptiveCardExtensionLoader._createQosExtraData = function (_a, appHostType) {
        ...
        if (getPositionOnPage) {
            ...
            if (cardPositionInfo) {
                qosExtraData.cardPosition = cardPositionInfo.componentOrder;
                qosExtraData.NumberOfCardsAudienceTargeted = cardPositionInfo.numberOfSectionComponents;
            }
        }
        if (!(0, Killswitches_1.isAddAppHostTypeToCardActionKSActivated)()) {
            // when gradutaing isAddAppHostTypeToCardActionKSActivated include appHostType to qosExtraData when object is created.
            qosExtraData.appHostType = appHostType;
        }
        if (!(0, Killswitches_1.isLogBotIdAndTeamsConnectedAppIdKSActivated)()) {
            // when gradutaing isLogBotIdAndTeamsConnectedAppIdKSActivated include botId and connectedTeamsAppId to qosExtraData when object is created.
            qosExtraData.botId = (_b = manifest.properties) === null || _b === void 0 ? void 0 : _b.botId;
            qosExtraData.connectedTeamsAppId = manifest.connectedTeamsAppId;
        }
        return qosExtraData;
    };
    /**
