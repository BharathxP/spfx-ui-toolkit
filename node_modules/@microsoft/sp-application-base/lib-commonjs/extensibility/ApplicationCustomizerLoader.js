...
var ApplicationCustomizerContextFactory_1 = tslib_1.__importDefault(require("./ApplicationCustomizerContextFactory"));
var BaseApplicationCustomizer_1 = tslib_1.__importDefault(require("./BaseApplicationCustomizer"));
var ClientSideCustomAction_1 = tslib_1.__importDefault(require("./customAction/ClientSideCustomAction"));
var CustomActionLocations_1 = tslib_1.__importDefault(require("./customAction/CustomActionLocations"));
var PlaceholderManager_1 = tslib_1.__importDefault(require("./placeholder/PlaceholderManager"));
...
var ApplicationCustomizerLoader = /** @class */ (function () {
    function ApplicationCustomizerLoader(serviceScope) {
        ...
        if (!(0, Killswitches_1.isAddEngagementLogKSActivated)()) {
            this._pageContext = serviceScope.consume(sp_page_context_1.PageContext.serviceKey);
        }
        this._extensionManager = new sp_extension_base_1._ExtensionManager(this._serviceScope, BaseApplicationCustomizer_1.default);
        this._applicationCustomizerContextFactory = new ApplicationCustomizerContextFactory_1.default(this._serviceScope);
    ...
    ApplicationCustomizerLoader.prototype.loadExtensions = function (preloadedCustomActions) {
        ...
        var areCustomActionsEqual = (!hadCustomActions && !willHaveCustomActions) ||
            (hadCustomActions && willHaveCustomActions && (0, sp_lodash_subset_1.isEqual)(this._currentCustomActions, futureCustomActions));
        ...
        if (hadCustomActions && !areCustomActionsEqual) {
            sp_diagnostics_1._TraceLogger.logVerbose(ApplicationCustomizerLoader._logSource, 'Disposing existing extensions');
        ...
        if ((willHaveCustomActions && !areCustomActionsEqual) || // If new custom actions are needed, load them
            ...
            sp_diagnostics_1._TraceLogger.logVerbose(ApplicationCustomizerLoader._logSource, 'Loading new extensions');
    ...
    ApplicationCustomizerLoader.prototype._loadDebugCustomizerIfEnabled = function () {
        ...
        if (sp_core_library_1._SPFlight.isDebugFlightEnabled &&
            sp_core_library_1._SPFlight.isEnabled(1178 /* SppplatDebugExtension */) &&
            !this._debugCustomizerLoaded &&
            (sp_core_library_1._SPFlight.isEnabled(60787 /* APEXEnableDebugApplicationWithScoping */) ||
                this._isDebugModeOn(/* params */ undefined))) {
            var customAction_1 = ClientSideCustomAction_1.default._tryCreateFromDebugData('ClientSideExtension.ApplicationCustomizer', sp_core_library_1.Guid.parse(debugApplicationCustomizerId), // component id
            undefined, // properties,
            0 // Sequence
            );
            if (customAction_1) {
                this._debugCustomizerLoaded = true;
                return sp_loader_1._ManifestStore.instance
                    .requestManifest(debugApplicationCustomizerId)
                    .then(function () {
                    void _this._createApplicationCustomizer(customAction_1);
                })
                    .catch(function (error) {
                    sp_diagnostics_1._TraceLogger.logError(ApplicationCustomizerLoader._logSource, error);
                });
            }
        }
    ...
    ApplicationCustomizerLoader.prototype._createApplicationCustomizer = function (customAction) {
        var _this = this;
        var qosMonitor = new sp_diagnostics_1._QosMonitor('ApplicationCustomizer.Create', true, true);
        return this._extensionManager
            ...
            qosMonitor.writeSuccess(_this._createQosExtraData(customAction, extension));
            return extension;
        })
            .catch(function (error) {
            var err = new Error("Failed to create application customizer '".concat(customAction.tag, "'. Error information is '").concat(error.message, "'."));
            qosMonitor.writeExpectedFailure('FailedCreateExtension', error, _this._createQosExtraData(customAction));
            sp_diagnostics_1._TraceLogger.logError(ApplicationCustomizerLoader._logSource, err);
            throw err;
        });
    };
    ApplicationCustomizerLoader.prototype._createQosExtraData = function (customAction, extension) {
        var _a, _b;
        var extraData = {
            customAction: customAction.tag
        };
        if (!(0, Killswitches_1.isAddEngagementLogKSActivated)()) {
            // we want more info for success
            extraData = tslib_1.__assign(tslib_1.__assign({}, extraData), { clientSideComponentId: customAction.clientSideComponentId.toString(), alias: extension === null || extension === void 0 ? void 0 : extension.manifest.alias, tenantId: (_b = (_a = this._pageContext) === null || _a === void 0 ? void 0 : _a.aadInfo) === null || _b === void 0 ? void 0 : _b.tenantId.toString() });
        }
        return extraData;
    };
    /**
    ...
    ApplicationCustomizerLoader.prototype._hasDebugCustomActions = function () {
        ...
        return (!!queryParameters.get('customActions') ||
            (sp_core_library_1._SPFlight.isDebugFlightEnabled &&
                sp_core_library_1._SPFlight.isEnabled(1178 /* SppplatDebugExtension */) && // for debug extension
                (sp_core_library_1._SPFlight.isEnabled(60787 /* APEXEnableDebugApplicationWithScoping */) ||
    ...
    ApplicationCustomizerLoader.prototype._loadCustomActionsFromQueryParameter = function () {
        ...
        var clientSideCustomActions = [];
        if (parameterValue) {
            var qosMonitor = new sp_diagnostics_1._QosMonitor('ApplicationCustomizerLoader.parseQueryParam');
            try {
                ...
                if (queryValue) {
                    for (var _i = 0, _a = Object.keys(queryValue); _i < _a.length; _i++) {
                        ...
                        if (clientSideComponentId && location_1) {
                            var customActions = ClientSideCustomAction_1.default._tryCreateFromDebugData(location_1, clientSideComponentId, properties ? JSON.stringify(properties) : '', sequence, hostProperties ? JSON.stringify(hostProperties) : '');
                            if (customActions) {
    ...
    ApplicationCustomizerLoader.prototype._processMissingManifestsErrors = function (missingManifestIds, qosMonitor) {
        ...
        sp_diagnostics_1._TraceLogger.logError(ApplicationCustomizerLoader._logSource, error, 'parseCustomActionsQueryParameter');
    ...
    ApplicationCustomizerLoader.prototype._processQueryParamParseErrors = function (error, parameterValue, qosMonitor) {
        sp_diagnostics_1._TraceLogger.logError(ApplicationCustomizerLoader._logSource, new Error('Failed to parse the "customActions" URL query parameter:' + error.message));
        // NOTE: Normally SPFx code does not use console.error(), but in this scenario we are
        // talking directly to a developer.  They really need to see this string without the
        // truncating/scrubbing that is normally performed by the Dev Dashboard "Trace" tab.
        // eslint-disable-next-line no-console
    ...
    ApplicationCustomizerLoader._logSource = sp_diagnostics_1._LogSource.create('ApplicationCustomizerLoader');
