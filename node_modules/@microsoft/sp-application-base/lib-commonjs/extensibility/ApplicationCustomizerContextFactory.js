...
var APPLICATION_CUSTOMIZER_TOP_HEIGHT = 'preAllocatedApplicationCustomizerTopHeight';
var APPLICATION_CUSTOMIZER_BOTTOM_HEIGHT = 'preAllocatedApplicationCustomizerBottomHeight';
var ApplicationCustomizerContextFactory = /** @class */ (function () {
    ...
    ApplicationCustomizerContextFactory.prototype.createApplicationCustomizerContext = function (customAction, extensionContextParameters, includeAllParams) {
        ...
        if (customAction.hostProperties) {
            topHeight =
                parseInt(JSON.parse(customAction.hostProperties)[APPLICATION_CUSTOMIZER_TOP_HEIGHT], 10) || 0;
            bottomHeight =
                parseInt(JSON.parse(customAction.hostProperties)[APPLICATION_CUSTOMIZER_BOTTOM_HEIGHT], 10) || 0;
        }
