...
var ApplicationManager = /** @class */ (function () {
    ...
    ApplicationManager.prototype._initializeApplication = function (application, applicationId) {
        ...
        if (!(0, Killswitches_1.isSPAppBarHiddenOnPublicationsKSActivated)()) {
            // On some cases, Page Chrome needs preloaded data to be initialized.
            preloadedData = this._navigator.preloadedData;
        }
        ...
        if (!isChromelessApplication) {
            if (pageChromeProvider) {
                ...
                if (!this._pageChrome) {
                    this._pageChrome = pageChromeProvider.initializePageChrome(this._serviceScope, this._masterChrome, applicationId, preloadedData);
        ...
        try {
            return this._currentApplication
                ...
                instanceId: applicationManifest.id, // There is only one app at the time. Use component id as instance id
