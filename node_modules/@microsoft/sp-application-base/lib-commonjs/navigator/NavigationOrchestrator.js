...
var NavigationOrchestrator = /** @class */ (function () {
    ...
    NavigationOrchestrator.prototype._updateTelemetry = function (preloadedData) {
        ...
        var appManifest;
        if (preloadedData.manifests && preloadedData.manifests.length > 0) {
            appManifest = preloadedData.manifests[0];
            if (!(0, Killswitches_1.isFindAppManifestInsteadUsingFirstKSActivated)()) {
                var foundManifest = preloadedData.manifests.find(function (manifest) { return manifest.id === preloadedData.clientSideApplicationId; });
                if (foundManifest) {
                    appManifest = foundManifest;
                }
            }
        }
        var manifestAlias = appManifest ? appManifest.alias : '';
        if (!(0, Killswitches_1.isOverrideWorkloadKSActivated)() &&
            appManifest &&
            appManifest.experimentalData &&
            appManifest.experimentalData[sp_loader_1._INCLUDE_APP_WORKLOAD]) {
            try {
        ...
        sp_telemetry_1._Telemetry.updateSettings({
            ...
            experimentData: this._pageContext.legacyPageContext.experimentData,
            experimentDataLookup: this._pageContext.legacyPageContext.experimentDataLookup
