...
var SearchQueryModifier = /** @class */ (function () {
    ...
    SearchQueryModifier.prototype.TestSetup = function () {
        ...
        this._linkPreviewWebpart = new SPTaskLib.LinkPreviewWebpart();
    ...
    SearchQueryModifier.prototype.TestRun = function () {
        ...
        this._AddTaskTestWithSearchQueryAndExtensionWithoutManifest();
        this._AddTaskTestWithLoadNoSearchQueryPageClickQueryLinkWebPart();
    };
    ...
    SearchQueryModifier.prototype._AddTaskSetupTestPage = function () {
        ...
        this._AddTaskSetupDynamicDataWebPart();
        /*Saving page first and then editing page following user behavior
        to make sure there is preview data for url in linkPreviewWebPart*/
        SPTaskLib.TeamSitePage.AddTaskSavePage();
        SPTaskLib.TeamSitePage.AddTaskEditPage();
        this._AddTaskSetupLinkPreviewWebPart();
        SPTaskLib.TeamSitePage.AddTaskSavePage();
    ...
    SearchQueryModifier.prototype._AddTaskSetupLinkPreviewWebPart = function () {
        TAB.Log.AddTaskComment('Creating link preview web part.');
        this._linkPreviewWebpart.addWebPartToPage();
        var urlWithQuery = this._getPageUrl('q=inPlaceNav');
        this._linkPreviewWebpart.AddTaskTryInputUrl(urlWithQuery, true);
        TAB.Log.AddTaskComment('Created link preview web part.');
    };
    SearchQueryModifier.prototype._AddTaskTestWithLoadNoSearchQueryPageClickQueryLinkWebPart = function () {
        var _this = this;
        TAB.Log.AddTaskComment('Test: In-place navigation to the same page from no search query to a search query with no extensions.');
        TAB.AddTask(TAB.LoadPage(this._getPageUrl()), SPTaskLib.TeamSitePage.PageReady());
        ...
        TAB.AddTask(undefined, TAB.MakeWaiter(function () {
            return _this._linkPreviewWebpart.UrlInputExists();
        }));
        this._linkPreviewWebpart.AddTaskClickUrlElement();
        TAB.Log.AddTaskComment('Navigating to the same page with a query param');
        TAB.AddTask(undefined, this._dynamicDataConsumerWebPart.WaitForDynamicDataRendering());
        this._AddTaskValidateSearchQueryValue('inPlaceNav', 'Search query data with a search query should be the search query');
    };
    ...
    SearchQueryModifier.prototype._AddTaskTestWithSearchQuery = function () {
        ...
        TAB.AddTask(TAB.LoadPage(this._getPageUrl('q=withoutSqm')), SPTaskLib.TeamSitePage.PageReady());
        TAB.AddTask(undefined, this._dynamicDataConsumerWebPart.WaitForDynamicDataRendering());
        this._AddTaskValidateSearchQueryValue('withoutSqm', 'Search query data with a search query should be the search query');
    };
    SearchQueryModifier.prototype._AddTaskTestWithSearchQueryAndExtension = function () {
        ...
        var customActions = '{"124cf3a4-cd42-4f3d-a21f-8ae3d416859c":{"location":"ClientSideExtension.SearchQueryModifier"}}';
        TAB.AddTask(TAB.LoadPage(this._getPageUrl('q=withSqm', customActions)), SPTaskLib.TeamSitePage.PageReady());
        TAB.AddTask(undefined, this._dynamicDataConsumerWebPart.WaitForDynamicDataRendering());
        this._AddTaskValidateSearchQueryValue('withSqm TAB TEST', 'Search query data with a search query and an extension should be the modified search query');
    };
    SearchQueryModifier.prototype._AddTaskTestWithSearchQueryAndExtensionWithoutManifest = function () {
        TAB.Log.AddTaskComment('Test: Check page with search query and a search query modifier.');
        var customActions = '{' +
            '"124cf3a4-cd42-4f3d-a21f-8ae3d416859c":{"location":"ClientSideExtension.SearchQueryModifier"},' +
            // Non existing guid. Only the first extension should load.
            '"fb663531-ce6c-45f5-953c-696c599191a4":{"location":"ClientSideExtension.SearchQueryModifier"}' +
            '}';
        TAB.AddTask(TAB.LoadPage(this._getPageUrl('q=goodSqmBadSqm', customActions)), SPTaskLib.TeamSitePage.PageReady());
        TAB.AddTask(undefined, this._dynamicDataConsumerWebPart.WaitForDynamicDataRendering());
        this._AddTaskValidateSearchQueryValue('goodSqmBadSqm TAB TEST', 'Search query data with a search query and an extension should be the modified search query');
    };
    /**
    ...
    SearchQueryModifier.prototype._AddTaskValidateSearchQueryValue = function (value, message) {
        ...
        TAB.AddTask(undefined, TAB.MakeWaiter(function () {
            ...
            var ddValue = _this._getDynamicDataValue();
