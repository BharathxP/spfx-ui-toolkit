define(["require", "exports", "tslib", "@fluentui/theme", "./variantThemeType"], function (require, exports, tslib_1, theme_1, variantThemeType_1) {
    ...
    exports.getStrongVariant = exports.getSoftVariant = exports.getNeutralVariant = exports.getVariant = void 0;
    function makeThemeFromPartials(originalTheme, partialPalette, partialSemantic) {
        // Create variant palette
        var variantTheme = (0, theme_1.createTheme)({ palette: tslib_1.__assign(tslib_1.__assign({}, originalTheme.palette), partialPalette) });
    ...
    function getVariant(theme, variant) {
        switch (variant) {
            ...
            default:
                return (0, theme_1.createTheme)(theme);
        }
    }
    ...
    function getNeutralVariant(theme) {
        var fullTheme = (0, theme_1.createTheme)(theme);
    ...
    function getStrongVariant(theme) {
        ...
        // Create variant palette
        var variantTheme = (0, theme_1.createTheme)({ palette: tslib_1.__assign(tslib_1.__assign({}, fullTheme.palette), partialPalette) });
        // Change semantic colors to use updated variant palette values
        variantTheme.semanticColors = tslib_1.__assign(tslib_1.__assign({}, variantTheme.semanticColors), partialSemantic);
        // Fill in the rest of the theme
