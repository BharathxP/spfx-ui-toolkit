    ...
    if (extension) {
        ...
        switch (type) {
            ...
            case FileIconType_1.FileIconType.loopworkspace:
                ...
                break;
            case FileIconType_1.FileIconType.planner:
                iconBaseName = PLANNER;
                break;
            case FileIconType_1.FileIconType.todoItem:
                iconBaseName = TODOITEM;
                break;
            case FileIconType_1.FileIconType.portfolio:
                iconBaseName = PORTFOLIO;
                break;
            case FileIconType_1.FileIconType.album:
                iconBaseName = ALBUM;
                break;
            case FileIconType_1.FileIconType.listForm:
...
function getFileTypeIconSuffix(size, imageFileType, win) {
    if (imageFileType === void 0) { imageFileType = 'svg'; }
    // eslint-disable-next-line no-restricted-globals
    win !== null && win !== void 0 ? win : (win = window);
