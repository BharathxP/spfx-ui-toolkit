...
var DynamicForm = /** @class */ (function (_super) {
    ...
    function DynamicForm(props) {
        ...
        _this.onSubmitClick = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, listId, listItemId, contentTypeId, onSubmitted, onBeforeSubmit, onSubmitError, shouldBeReturnBack_1, fields, objects, _loop_1, this_1, i, len, isCancelled, iur, error_1, iar, error_2, idField, titleField, contentTypeIdField, library, folderTitle, newFolder, fields_1, folderId, iur, error_3, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 12:
                        if (!(contentTypeId === undefined || contentTypeId === '')) return [3 /*break*/, 26];
                        if (!!contentTypeId.startsWith('0x0120')) return [3 /*break*/, 17];
                        _b.label = 13;
                    case 13:
        ...
        _this.getFieldInformations = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, listId, listItemId, disabledFields, contentTypeId, spList, item, defaultContentType, listFields, tempFields, order, responseValue, hiddenFields, defaultDayOfWeek, _loop_2, this_2, i, len, error_5;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 7:
                        ...
                        _loop_2 = function (i, len) {
                            var field, fieldType, hiddenName, termSetId, anchorId, lookupListId, lookupField, choices_1, defaultValue, selectedTags_1, richText, dateFormat, principalType, response, response, schemaXml, dateFormatRegEx, userEmails, _c, _d;
