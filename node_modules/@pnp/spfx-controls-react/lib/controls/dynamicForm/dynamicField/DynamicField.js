...
var DynamicField = /** @class */ (function (_super) {
    ...
    function DynamicField(props) {
        ...
        _this.getFieldComponent = function () {
            ...
            //bingAPIKey,
            dateFormat = _a.dateFormat, firstDayOfWeek = _a.firstDayOfWeek, columnInternalName = _a.columnInternalName, principalType = _a.principalType, description = _a.description;
            ...
            switch (fieldType) {
                ...
                case 'Note':
                    if (isRichText) {
                        var value = _this.props.newValue ? _this.props.newValue : defaultValue;
                        return React.createElement("div", { className: styles.richText },
                            React.createElement("div", { className: styles.titleContainer },
                                ...
                                labelEl),
                            React.createElement(RichText, { placeholder: placeholder, value: value, className: styles.feildDisplay, onChange: function (newText) { _this.onChange(newText); return newText; }, isEditMode: disabled }),
                            descriptionEl,
                            errorTextEl);
                    }
                    else {
                ...
                case 'Lookup':
                    return React.createElement("div", null,
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        React.createElement(ListItemPicker, { disabled: disabled, listId: lookupListID, defaultSelectedItems: defaultValue, columnInternalName: lookupField, className: styles.feildDisplay, enableDefaultSuggestions: true, keyColumnInternalName: 'Id', itemLimit: 1, onSelectedItem: function (newValue) { _this.onChange(newValue); }, context: context }),
                        descriptionEl,
                        errorTextEl);
                case 'LookupMulti':
                    return React.createElement("div", null,
                ...
                case 'DateTime':
                    return React.createElement("div", { className: styles.fieldContainer },
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        dateFormat === 'DateOnly' &&
                            React.createElement(DatePicker, { placeholder: placeholder, className: styles.pickersContainer, formatDate: function (date) { return date.toLocaleDateString(context.pageContext.cultureInfo.currentCultureName); }, value: (changedValue !== null && changedValue !== "") ? changedValue : defaultValue, onSelectDate: function (newDate) { _this.onChange(newDate); }, disabled: disabled, firstDayOfWeek: firstDayOfWeek }),
                        dateFormat === 'DateTime' &&
                            React.createElement(DateTimePicker, { key: columnInternalName, placeholder: placeholder, formatDate: function (date) { return date.toLocaleDateString(context.pageContext.cultureInfo.currentCultureName); }, value: (changedValue !== null && changedValue !== "") ? changedValue : defaultValue, onChange: function (newDate) { _this.onChange(newDate); }, disabled: disabled, firstDayOfWeek: firstDayOfWeek }),
                        descriptionEl,
                        errorTextEl);
                case 'Boolean':
                    return React.createElement("div", null,
                ...
                case 'TaxonomyFieldType':
                    return React.createElement("div", { className: styles.fieldContainer },
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        React.createElement("div", { className: styles.pickersContainer },
                            React.createElement(TaxonomyPicker, { label: "", disabled: disabled, initialValues: defaultValue, placeholder: placeholder, allowMultipleSelections: false, termsetNameOrID: fieldTermSetId, anchorId: fieldAnchorId, panelTitle: strings.DynamicFormTermPanelTitle, context: context, onChange: function (newValue) { _this.onChange(newValue); }, isTermSetSelectable: false })),
                        descriptionEl,
                        errorTextEl);
            }
            return null;
