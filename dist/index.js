...
var officeUiFabricReact = require('office-ui-fabric-react');
...
var TextInput = function TextInput(_ref) {
  ...
  var _useState = React.useState(errorMessage),
    error = _useState[0],
    setError = _useState[1];
  var _useState2 = React.useState(!!errorMessage),
  ...
  return React__default.createElement("div", null, !hideLabel ? React__default.createElement(officeUiFabricReact.Label, {
    style: {
      fontSize: '13px',
      color: '#475055'
    },
    required: required
  }, label) : null, isPreview ? React__default.createElement(React__default.Fragment, null, multiline ? React__default.createElement(React__default.Fragment, null, React__default.createElement("span", null, (value === null || value === void 0 ? void 0 : value.replaceAll(decodeURIComponent("%0A"), "<br>")) || "")) : React__default.createElement("span", null, isLink ? React__default.createElement("a", {
  ...
  }, value) : value)) : React__default.createElement(React__default.Fragment, null, React__default.createElement(officeUiFabricReact.TextField, {
    value: value,
    ...
    type: type,
    rows: rows
  }), (showError || error) && React__default.createElement("div", {
    style: {
      color: '#a4262c',
      fontSize: '12px',
      display: 'flex',
  ...
  }, React__default.createElement(officeUiFabricReact.Icon, {
    style: {
      marginTop: '2px'
    },
    iconName: "IncidentTriangle"
  }), React__default.createElement("span", null, error || errorMessage))));
};

var Button = function Button() {
  var _useState = React.useState('green'),
    color = _useState[0],
...
var DateInput = function DateInput(_ref) {
  ...
  var _React$useState2 = React__default.useState(!!errorMessage),
  ...
  return React__default.createElement("div", null, !hideLabel ? React__default.createElement(officeUiFabricReact.Label, {
    ...
    required: required
  }, label) : null, isPreview ? React__default.createElement("span", null, value ? moment(value).format(globalDateFormat) : '') : React__default.createElement(React__default.Fragment, null, React__default.createElement(officeUiFabricReact.DatePicker, {
    styles: Styles,
    ...
    minDate: minDate,
    maxDate: maxDate
  }), showError && React__default.createElement("div", {
    style: {
      color: '#a4262c',
      fontSize: '12px',
      display: 'flex',
